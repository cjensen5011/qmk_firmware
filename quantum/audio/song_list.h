 ...
 */
#define SANDYS_CITY H__NOTE(_D4), H__NOTE(_F4), H__NOTE(_F4), H__NOTE(_D4), H__NOTE(_AS5), H__NOTE(_AS5), H__NOTE(_D4), H__NOTE(_G5),  H__NOTE(_G5),  W__NOTE(_F5), W__NOTE(_G5), W__NOTE(_F5), W__NOTE(_E5),
